...
$(document).ready(function() {
	...
	$('#submit_it').click(function(e) {
		...
		ajaxObj = {  
			type: "POST",
			url: "http://"+url+":7001/com.telemedicine.pucit/api/addpatient",
//			url: "http://localhost:7001/com.telemedicine.pucit/api/addpatient",
...
//			url: "http://localhost:7001/com.telemedicine.pucit/api/add",
			url: "http://"+url+":7001/com.telemedicine.pucit/api/addperscription",
			data: JSON.stringify(jsObj), 
			contentType:"application/json",
			error: function(jqXHR, textStatus, errorThrown) {
				console.log("Error " + jqXHR.getAllResponseHeaders() + " " + errorThrown);
